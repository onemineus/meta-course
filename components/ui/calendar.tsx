...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("w-full p-4 bg-zinc-900 rounded-lg", className)}
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md mx-1 w-9 font-normal text-[0.8rem]",
        ...
        day_today: "bg-white text-slate-900 font-bold",
