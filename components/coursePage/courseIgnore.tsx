...
import { formatDate, getRoomCode } from "@/lib/utils";
                  ...
                  {data.accordion.map((item, index) => {
                    return (
                      <AccordionItem key={index} value={index.toString()}>
                        <AccordionTrigger className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-left font-bold text-transparent">
                          {item.title}
                        </AccordionTrigger>
